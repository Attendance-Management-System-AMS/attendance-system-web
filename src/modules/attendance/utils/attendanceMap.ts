import type { Attendance, AttendanceStatus } from '@/modules/attendance/types/attendance.types'
import type { Employee } from '@/modules/employees/types/employee.types'
import type { AttendanceTodayApiRecord } from '@/modules/attendance/api/attendance.api'
