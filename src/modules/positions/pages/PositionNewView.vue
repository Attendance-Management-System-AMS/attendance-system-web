...
import type { CreatePosition } from '@/modules/positions/types/position.types'
          ...
          <div class="space-y-3">
            <button
              ...
              :class="[
                ...
                createPosition.isPending.value ? 'bg-primary cursor-not-allowed' : 'bg-primary hover:bg-primary',
              ]"
            >
              <Save class="h-4 w-4" />
