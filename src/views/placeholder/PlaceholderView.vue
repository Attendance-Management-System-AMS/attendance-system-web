...
<template>
    <div class="space-y-6">
        ...
        <div
            class="flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 bg-white py-24 dark:border-slate-800 dark:bg-slate-900">
            ...
            <p class="mt-1.5 text-sm text-slate-400 text-center max-w-xs">
                Tính năng <span class="font-semibold text-indigo-600">{{ title }}</span> đang được hoàn thiện theo tiêu
                chuẩn Enterprise.
            </p>
        </div>
    </div>
