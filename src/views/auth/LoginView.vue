...
import { Clock3, Eye, EyeOff, Fingerprint, LockKeyhole, Mail } from 'lucide-vue-next'
...
<template>
    <div
        ...
        <div
            class="pointer-events-none absolute right-0 bottom-0 h-80 w-80 rounded-full bg-cyan-300/20 blur-3xl dark:bg-cyan-500/10" />

        <div
            class="relative z-10 mx-auto flex min-h-screen w-full items-center justify-center px-4 py-8 sm:px-6 lg:px-8">
            <div class="w-full max-w-md">
                <section
                    class="rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl shadow-indigo-200/30 dark:border-slate-800 dark:bg-slate-900 sm:p-8">
                    <div class="mb-6">
                        <p class="text-xs font-bold uppercase tracking-wider text-indigo-600 dark:text-indigo-400">Đăng
                            nhập hệ thống</p>
                        <h2 class="mt-2 text-2xl font-black text-slate-900 dark:text-white">Chào mừng quay lại</h2>
                        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Sử dụng tài khoản nội bộ để truy cập
                            TimeMaster AMS.</p>
                    </div>
                    ...
                    <form class="space-y-4" @submit.prevent="handleSubmit">
                        <div>
                            <label
                                class="mb-1.5 block text-xs font-bold uppercase tracking-wider text-slate-500">Email</label>
                            <div class="relative">
                                <Mail
                        ...
                        <div>
                            <label class="mb-1.5 block text-xs font-bold uppercase tracking-wider text-slate-500">Mật
                                khẩu</label>
                            <div class="relative">
                                <LockKeyhole
                                    class="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400" />
